...
\section{Rationale}
\todo[inline,color=orange]{Make rationale more rationaley}
...
\todo[inline,color=green]{More about how terrible energy consumption is}
...
\todo{Energy awareness is what we want to solve!}
...
\todo{Introduce energy awareness a bit first}
...
\todo{Redo this part}
\todo{The human eye can only see 25 fps}
...
\todo{State points to be solved in this project}
\begin{itemize}
 \item thing 1
 \item thing 2
 \item thing 3
...
\todo[inline, color=green]{Where to be placed?}
