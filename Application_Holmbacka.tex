...
The US Department of Energy define a maximum power envelope of 20 MW\footnote{http://ascr-discovery.science.doe.gov/2014/11/exascale-road-bumps/} for a single data center, but with current technology, an exa-scale computing center would require over 7000 MW.\smallskip
...
This means that as transistors become smaller, energy efficiency is not anymore improved by transistor technology alone, such that the power remains in proportion to the chip area. 
...
Hardware alone in form of battery development in mobile phones cannot keep phase with the progress in processor capacity \cite{CPUCapacity,BatteryCapacity},
and the problem to reach millivolt switch voltage in transistors prohibits chip manufacturers from operating on lower voltages than about 1v. \smallskip

In order to solve the mentioned problems in this interdisciplinary domain, software must be more involved in making the computer systems energy efficient again.
...
Energy savings as much as 50-60\% was obtained in our previous work \cite{Holmbacka:15} using real-world Linux platforms without loosing any performance.
...
Part B) in Figure \ref{fig:EAS} illustrates the addition of energy awareness, the application can directly communicate with the runtime system, resulting in better accuracy of resource allocation, increase self awareness and lower energy consumption.\smallskip
