...
Guidelines from Intel [REF] suggests the use of a certain level of loop unrolling, memory intensity \todo[color=green]{More here} for achieving maximum energy efficiency in combination with intel compiler tools. 
...
\subsection{Budget}
\todo[inline,color=orange]{Pengaa}
