...
In desktop and server systems, our limited power envelope for a processor chip on roughly 250W prohibits a processor from utilizing all of its hardware simultaneously; a phenomenon called ``dark silicon''.
...
In order to solve the mentioned problems in this interdisciplinary domain, the right amount of hardware resources must be dynamically allocated and minimal resources should be wasted.
