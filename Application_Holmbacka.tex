...
Our newly funded AKA project \textbf{Efficient Stream Computing (ESC)} introduces a formal and practical paradigm of measuring efficiency of software execution through the notion of \textit{Fitness},
...
The commonality of this project is energy efficient execution, but while ESC focuses more on \textit{where to map} a task, the primary goal of this project is to optimize resource allocation and how software can influence this decision.
...
Joint articles have been published in the COST action between the PI and the group in TU Wien led by Ivona Brandi\'{c} and one between the PI and the group in University of Tirana led by Neki Frasheri, one of which has been published in IEEE Transactions.\smallskip
...
The PI was awarded the \textit{Researcher of the Year} for best PhD thesis during the year 2016; this project is a continuation of this thesis.
